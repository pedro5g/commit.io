...
// checks whether the terminal supports interactive
// commands such as colors and styles.
...
function info(msg: string, context?: unknown): void {
...
function error(error: Error | string, context?: unknown): void {
